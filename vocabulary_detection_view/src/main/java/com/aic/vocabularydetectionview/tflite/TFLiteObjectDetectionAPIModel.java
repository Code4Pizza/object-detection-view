...
package com.aic.vocabularydetectionview.tflite;
...
public class TFLiteObjectDetectionAPIModel implements Detector {
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    for (Detection detection : results) {
      ...
      try {
//        Bitmap croppedBmp = Bitmap.createBitmap(bitmap, (int) rectF.left, (int) rectF.top, (int) rectF.width(), (int) rectF.height());
        recognitions.add(
                new Recognition(
                        "" + cnt++,
...
//        Log.d("=======>", "processImage: " + croppedBmp.getWidth() + " - " + croppedBmp.getHeight());
